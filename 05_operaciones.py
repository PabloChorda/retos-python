...
Genere dos listas de números aleatorios de longitud variable.
Compare ambas listas para determinar:
Los elementos comunes.
Los elementos únicos en cada lista.
Si una es una subsecuencia de la otra.
Calcule la suma acumulativa y el producto de los elementos de cada lista.
